...
A successful project requires many people to play many roles. Some members write code or documentation, while others are valuable as testers, submitting patches and suggestions.</p>
...
| Matt Sicker | mattsicker at apache.org | PMC Chair | Log4j2
...
| Ron Grabowski | rgrabowski at apache.org | PMC Member | Log4net | Last Active 2010
...
| Mikael Ståldal | mikes at apache.org | PMC</span> Member| log4j2 | Last Active 2018
