...
The following is an extract from https://www.apache.org/foundation/records/minutes/2003/board_minutes_2003_12_17.txt[the minutes of the meeting of the board of directors].

[quote,Establishment of the Apache Logging Services Project]
____
