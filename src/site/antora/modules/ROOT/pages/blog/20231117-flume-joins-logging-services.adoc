...
We are excited to announce that https://github.com/apache/flume[Apache Flume] is now a part of our Logging Services family.
...
As always, Apache Flume is developed under the Apache License. While we are still merging
